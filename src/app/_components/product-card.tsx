...
export function ProductCard({ product }: Props) {
  ...
  return (
    <div className="group bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden h-[560px] flex flex-col">
